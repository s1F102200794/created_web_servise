...
def Hokkaido_weather(request):
    ...
    return render(request, 'weather/Hokkaido.html', context)

@login_required
def Tohoku_weather(request):
    ...
    return render(request, 'weather/Tohoku.html', context)

@login_required
def Kanto_weather(request):
    ...
    return render(request, 'weather/Kanto.html', context)

@login_required
def Chubu_weather(request):
    ...
    return render(request, 'weather/Chubu.html', context)

@login_required
def Kinki_weather(request):
    ...
    return render(request, 'weather/Kinki.html', context)

@login_required
def Chugoku_weather(request):
    ...
    return render(request, 'weather/Chugoku.html', context)

@login_required
def Shikoku_weather(request):
    ...
    return render(request, 'weather/Shikoku.html', context)

@login_required
def Kyusyu_weather(request):
    ...
    return render(request, 'weather/Kyusyu.html', context)
